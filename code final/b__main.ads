...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#48dd47df#;
   ...
   u00136 : constant Version_32 := 16#db62029b#;
   pragma Export (C, u00136, "huffmanB");
   u00137 : constant Version_32 := 16#11f28d50#;
   pragma Export (C, u00137, "huffmanS");
   u00138 : constant Version_32 := 16#fb0d08f6#;
   pragma Export (C, u00138, "ada__directoriesB");
   u00139 : constant Version_32 := 16#9da5f6a3#;
   pragma Export (C, u00139, "ada__directoriesS");
   u00140 : constant Version_32 := 16#b8719323#;
   pragma Export (C, u00140, "ada__calendarB");
   u00141 : constant Version_32 := 16#41508869#;
   pragma Export (C, u00141, "ada__calendarS");
   u00142 : constant Version_32 := 16#24ec69e6#;
   pragma Export (C, u00142, "system__os_primitivesB");
   u00143 : constant Version_32 := 16#355de4ce#;
   pragma Export (C, u00143, "system__os_primitivesS");
   u00144 : constant Version_32 := 16#05c60a38#;
   pragma Export (C, u00144, "system__task_lockB");
   u00145 : constant Version_32 := 16#532ab656#;
   ...
   u00147 : constant Version_32 := 16#95569f93#;
   pragma Export (C, u00147, "ada__calendar__formattingB");
   u00148 : constant Version_32 := 16#7ddaf16f#;
   pragma Export (C, u00148, "ada__calendar__formattingS");
   u00149 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00149, "ada__calendar__time_zonesB");
   u00150 : constant Version_32 := 16#77b56b93#;
   pragma Export (C, u00150, "ada__calendar__time_zonesS");
   u00151 : constant Version_32 := 16#c2ca0511#;
   pragma Export (C, u00151, "system__val_realB");
   u00152 : constant Version_32 := 16#cc89f629#;
   ...
   u00155 : constant Version_32 := 16#36373acb#;
   ...
   u00158 : constant Version_32 := 16#62d0e74f#;
   pragma Export (C, u00158, "system__powten_tableS");
   u00159 : constant Version_32 := 16#4fedafb0#;
   pragma Export (C, u00159, "ada__directories__validityB");
   u00160 : constant Version_32 := 16#498b13d5#;
   ...
   u00167 : constant Version_32 := 16#acee74ad#;
   pragma Export (C, u00167, "system__compare_array_unsigned_8B");
   u00168 : constant Version_32 := 16#9ba3f0b5#;
   pragma Export (C, u00168, "system__compare_array_unsigned_8S");
   u00169 : constant Version_32 := 16#a8025f3c#;
   pragma Export (C, u00169, "system__address_operationsB");
   u00170 : constant Version_32 := 16#21ac3f0b#;
   pragma Export (C, u00170, "system__address_operationsS");
   u00171 : constant Version_32 := 16#2e260032#;
   pragma Export (C, u00171, "system__storage_pools__subpoolsB");
   u00172 : constant Version_32 := 16#cc5a1856#;
   pragma Export (C, u00172, "system__storage_pools__subpoolsS");
   u00173 : constant Version_32 := 16#d96e3c40#;
   pragma Export (C, u00173, "system__finalization_mastersB");
   u00174 : constant Version_32 := 16#695cb8f2#;
   pragma Export (C, u00174, "system__finalization_mastersS");
   u00175 : constant Version_32 := 16#7268f812#;
   pragma Export (C, u00175, "system__img_boolB");
   u00176 : constant Version_32 := 16#c779f0d3#;
   pragma Export (C, u00176, "system__img_boolS");
   u00177 : constant Version_32 := 16#6d4d969a#;
   pragma Export (C, u00177, "system__storage_poolsB");
   u00178 : constant Version_32 := 16#114d1f95#;
   pragma Export (C, u00178, "system__storage_poolsS");
   u00179 : constant Version_32 := 16#84042202#;
   pragma Export (C, u00179, "system__storage_pools__subpools__finalizationB");
   u00180 : constant Version_32 := 16#fe2f4b3a#;
   ...
   u00182 : constant Version_32 := 16#86fcacb5#;
   pragma Export (C, u00182, "system__atomic_countersS");
   u00183 : constant Version_32 := 16#039168f8#;
   pragma Export (C, u00183, "system__stream_attributesB");
   u00184 : constant Version_32 := 16#8bc30a4e#;
   pragma Export (C, u00184, "system__stream_attributesS");
   u00185 : constant Version_32 := 16#3270c150#;
   pragma Export (C, u00185, "system__file_attributesS");
   u00186 : constant Version_32 := 16#49fe785b#;
   pragma Export (C, u00186, "system__os_constantsS");
   u00187 : constant Version_32 := 16#95f86c43#;
   pragma Export (C, u00187, "system__regexpB");
   u00188 : constant Version_32 := 16#119226f4#;
   pragma Export (C, u00188, "system__regexpS");
   u00189 : constant Version_32 := 16#a347755d#;
   pragma Export (C, u00189, "ada__text_io__modular_auxB");
   u00190 : constant Version_32 := 16#bd5ba9c9#;
   pragma Export (C, u00190, "ada__text_io__modular_auxS");
   u00191 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00191, "system__img_lluB");
   u00192 : constant Version_32 := 16#4feffd78#;
   pragma Export (C, u00192, "system__img_lluS");
   u00193 : constant Version_32 := 16#8d7d0907#;
   pragma Export (C, u00193, "readerB");
   u00194 : constant Version_32 := 16#cecebc35#;
   pragma Export (C, u00194, "readerS");
   u00195 : constant Version_32 := 16#4b3cf578#;
   pragma Export (C, u00195, "system__byte_swappingS");
   u00196 : constant Version_32 := 16#67c262fe#;
   pragma Export (C, u00196, "system__sequential_ioB");
   u00197 : constant Version_32 := 16#d8cc2bc8#;
   pragma Export (C, u00197, "system__sequential_ioS");
   u00198 : constant Version_32 := 16#2b93a046#;
   pragma Export (C, u00198, "system__img_charB");
   u00199 : constant Version_32 := 16#ae94d9df#;
   pragma Export (C, u00199, "system__img_charS");
   u00200 : constant Version_32 := 16#67f08ba1#;
   pragma Export (C, u00200, "tableauxB");
   u00201 : constant Version_32 := 16#648ea6c5#;
   pragma Export (C, u00201, "tableauxS");
   u00202 : constant Version_32 := 16#a441ba3a#;
   pragma Export (C, u00202, "treeB");
   u00203 : constant Version_32 := 16#c26b84d3#;
   pragma Export (C, u00203, "treeS");
   u00204 : constant Version_32 := 16#a266d509#;
   pragma Export (C, u00204, "writerB");
   u00205 : constant Version_32 := 16#b4b460e1#;
   pragma Export (C, u00205, "writerS");
