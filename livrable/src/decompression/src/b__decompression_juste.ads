...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_decompression_juste" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6e40a650#;
   pragma Export (C, u00001, "decompression_justeB");
   ...
   u00114 : constant Version_32 := 16#4b3cf578#;
   pragma Export (C, u00114, "system__byte_swappingS");
   u00115 : constant Version_32 := 16#2b93a046#;
   pragma Export (C, u00115, "system__img_charB");
   u00116 : constant Version_32 := 16#ae94d9df#;
   pragma Export (C, u00116, "system__img_charS");
   u00117 : constant Version_32 := 16#67c262fe#;
   pragma Export (C, u00117, "system__sequential_ioB");
   u00118 : constant Version_32 := 16#d8cc2bc8#;
   pragma Export (C, u00118, "system__sequential_ioS");
