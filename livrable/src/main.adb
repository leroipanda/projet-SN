...
procedure main is
   ...
   begin
      --calcule de la nouvelle fr�quence
...
begin
   ...
   --on trie la liste en fonction des fr�quences
   Put_Line("tri");
...
--on associe le code binnaire à chaque caractère grâce à l'arbre de huffman 

while listeArbre /= null loop 

--on detemine le code binaire du caractère 
